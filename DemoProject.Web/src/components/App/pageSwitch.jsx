  ...
  render() {
    return (
      <Switch>
        ...
        <AuthRoute exact path={RoutePath.ADMIN} roles={RoleEnum.Admin} component={AdminHomePage} />
        <AuthRoute exact path={RoutePath.ADMIN_USERS_ALL} roles={RoleEnum.Admin} component={UsersPage} />
        <AuthRoute exact path={RoutePath.ADMIN_REGISTER_USER} roles={RoleEnum.Admin} component={RegisterUserPage} />
